...
import static com.application.constants.SecurityConstants.*;
...
public class JWTTokenProvider {
    ...
    private String[] getClaimsFromUser(UserPrincipal userPrincipal) {
        ...
        for(GrantedAuthority grantedAuthority : userPrincipal.getAuthorities()){ authorities.add(grantedAuthority.getAuthority()); }
